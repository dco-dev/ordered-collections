(ns com.dean.ordered-collections.core
  ...
  (:require [clojure.core.reducers                            :as r]
            ...
            [com.dean.ordered-collections.types.fuzzy-map           :as fuzzy-map]
            [com.dean.ordered-collections.types.fuzzy-set           :as fuzzy-set]
            [com.dean.ordered-collections.types.interval-map        :refer [->IntervalMap]]
            [com.dean.ordered-collections.types.interval-set        :refer [->IntervalSet]]
            [com.dean.ordered-collections.types.ordered-map         :refer [->OrderedMap]
                                                                    :as omap]
            [com.dean.ordered-collections.types.ordered-multiset    :as multiset]
            [com.dean.ordered-collections.types.ordered-set         :refer [->OrderedSet]]
            [com.dean.ordered-collections.types.priority-queue      :as pq]
            [com.dean.ordered-collections.types.range-map           :as rmap]
            [com.dean.ordered-collections.types.segment-tree        :as segtree]
            [com.dean.ordered-collections.protocol                  :as proto]
            [com.dean.ordered-collections.util                      :refer [defalias]])
  (:import  [com.dean.ordered_collections.types.ordered_map OrderedMap]
            [com.dean.ordered_collections.types.ordered_set OrderedSet]
